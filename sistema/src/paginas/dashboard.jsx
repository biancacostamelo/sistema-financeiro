...
const Dashboard = () => {
  ...
  <div className="container">
    <div className="row">
      {/* Coluna principal com gráfico de linha */}
      ...
      {/* Agrupamento das colunas menores dentro de uma col-md-5 */}
      <div className="col-md-5">
        {/* Primeiro card (entradas) */}
        ...
        {/* Segundo card (Gastos por Tipo de Pagamento) */}
        
      </div>

      {/* Linha separada para os 2 últimos gráficos */}
